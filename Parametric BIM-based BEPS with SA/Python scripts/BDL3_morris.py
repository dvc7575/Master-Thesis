...
problem = read_param_file(r"C:\Users\daovi\Documents\data\Morris\BDL3\parameter_file.txt")
problem.pop('groups')
# param_values = sample(problem, N=100, num_levels=4, optimal_trajectories=64)

param_values = np.loadtxt(r"C:\Users\daovi\Documents\Jiabin_BDL3_1200-withresults\Jiabin_BDL3_1200\model_input.txt")
# read_param_file(r"C:\Users\daovi\Documents\data\BDL3_m\model_input.txt")

# with open(r"C:\Users\daovi\Documents\data\Morris\BDL3\model_input.txt", 'w') as mi:
#     np.savetxt(mi,param_values)

data = np.loadtxt(r"C:\Users\daovi\Documents\Jiabin_BDL3_1200-withresults\Jiabin_BDL3_1200\model_output.txt")
...
# horizontal_bar_plot(ax1, Si_1, {}, sortby="mu_star")
# covariance_plot(ax2, Si_1, {})
